...
kvalue = []
klabel=[klabel.replace('LAMBDA','$\Lambda$') for klabel in klabel]
klabel=[klabel.replace('DLTA','$\Delta$') for klabel in klabel]
...
myxlabel = plt.xlabel('Vecteur D\'onde K')
myylabel = plt.ylabel('$E-E_f \, (eV)$')
